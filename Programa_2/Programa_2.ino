...
void loop() {                 //Inicia el bucle del programa
  ...
  digitalWrite(led3, HIGH);    // posar a 5V el pin 2
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led2, HIGH);     // posar a 0V el pin 3
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led1, HIGH);     // posar a 0V el pin 4
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led4, HIGH);     // posar a 0V el pin 5
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led7, HIGH);     // posar a 0V el pin 6
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led8, HIGH);     // posar a 0V el pin 7
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led9, HIGH);     // posar a 0V el pin 8
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led6, HIGH);     // posar a 0V el pin 9
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led5, HIGH);     // posar a 0V el pin 10
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led3, LOW);    // posar a 5V el pin 2
  digitalWrite(led2, LOW);     // posar a 0V el pin 3
  digitalWrite(led1, LOW);     // posar a 0V el pin 4
  digitalWrite(led7, LOW);     // posar a 0V el pin 6
  digitalWrite(led8, LOW);     // posar a 0V el pin 7
  digitalWrite(led9, LOW);     // posar a 0V el pin 8
  digitalWrite(led6, LOW);     // posar a 0V el pin 9
  digitalWrite(led5, LOW);     // posar a 0V el pin 10
  digitalWrite(led4, LOW);     // posar a 0V el pin 10

  
  digitalWrite(npn1, LOW);    // posar a 5V el pin 11
  digitalWrite(npn2, HIGH);     // posar a 0V el pin 12
  digitalWrite(npn3, LOW);     // posar a 0V el pin 13
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led3, HIGH);    // posar a 5V el pin 2
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  ...
  digitalWrite(npn1, LOW);    // posar a 5V el pin 11
  digitalWrite(npn2, LOW);     // posar a 0V el pin 12
  digitalWrite(npn3, HIGH);     // posar a 0V el pin 13
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led3, HIGH);    // posar a 5V el pin 2
  delay(velocitat);            // es queden leds velocitat ms en aquest estat
  digitalWrite(led2, HIGH);     // posar a 0V el pin 3
